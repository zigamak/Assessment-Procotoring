<?php
// auth/payment.php
// Handles user registration and payment for an assessment.
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $quiz_id) {
    ...
    $gender = sanitize_input($_POST['gender'] ?? ''); // New field
    $address = sanitize_input($_POST['address'] ?? ''); // New field
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden">
            ...
            <div class="p-12 relative">
                <h2 class="text-3xl font-bold text-gray-800 mb-6 text-center">Registration & Payment</h2>
