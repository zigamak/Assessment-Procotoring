...
<body class="flex min-h-screen">
    ...
    <aside class="w-64 bg-theme-color text-white shadow-lg flex flex-col fixed inset-y-0 left-0 z-40">
        <div class="p-6 text-3xl font-bold border-b border-gray-700">
            <a href="<?php echo BASE_URL; ?>student/dashboard.php" class="hover:text-gray-200">Student Portal</a>
        </div>
        <nav class="flex-grow p-4">
            <ul class="space-y-2">
                ...
                <!-- Removed "Take Quiz" as per request, users will start from dashboard -->
                <li>
                    <a href="<?php echo BASE_URL; ?>student/view_history.php"
                       class="flex items-center p-3 rounded-md hover:bg-green-800 transition duration-300
                       <?php echo (basename($_SERVER['PHP_SELF']) == 'view_history.php') ? 'bg-green-800' : ''; ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="<?php echo BASE_URL; ?>student/profile.php"
                       class="flex items-center p-3 rounded-md hover:bg-green-800 transition duration-300
                       <?php echo (basename($_SERVER['PHP_SELF']) == 'profile.php') ? 'bg-green-800' : ''; ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
